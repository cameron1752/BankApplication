...
<%-- 
    ...
    Created on : Dec 12, 2020, 12:38:27 PM
    Author     : cammy
--%>
...
<html lang="en">
  ...
  <body>
      <!-- body code goes here -->
        ...
        <jsp:setProperty name="LoginManager" property="accountSelected" param="account1"/>
        <jsp:setProperty name="LoginManager" property="secondAccountSelected" param="account2"/>
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent1">
        ...
        <div class="card-body">
            <form action="landing.jsp">
                <p> Successful deposit of <jsp:getProperty name="LoginManager" property="amount"/> into <jsp:getProperty name="LoginManager" property="secondAccountSelected"/> from <jsp:getProperty name="LoginManager" property="accountSelected"/>  <jsp:getProperty name="LoginManager" property="FName"/>!
